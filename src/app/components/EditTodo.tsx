...
async function handleUpdate(e:any)
{
  ...
  return (
   <div    className="flex  gap-2  mb-4 mt-8">
      ...
      <input type="text" value={updatedTodo} className ="border border-gray-400 rounded-full px-2 py-2 w-[350px] break-words " onChange={(e)=>setUpdatedTodo(e.target.value)}></input>
